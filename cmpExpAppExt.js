...
CTPS.cmpExpApp.initDetailMap = function() {	
	...
	var oSpeedData = new ol.layer.Tile({	
		source: new ol.source.TileWMS({
			url		: CTPS.cmpExpApp.szWMSserverRoot,
			params	: {
				'LAYERS': 'postgis:ctps_cmp_2014_exp_routes_ext', 
				'STYLES': 'line',
				'TRANSPARENT': 'true'
			}
		}),
...
CTPS.cmpExpApp.initOverviewMap = function() {
	...
	// CTPS.cmpExpApp.szWMSserverRoot2 = 'http://ctps.org/map/ags/Expressway_Overview_Layers_Ext/MapServer/WMSServer';
...
CTPS.cmpExpApp.initDownloadText = function() {
	...
	szTemp += "&typename=postgis:ctps_cmp_2014_exp_routes_ext";
